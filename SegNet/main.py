...
tf.app.flags.DEFINE_string('log_dir', "/pylon5/sy4s8lp/kbushman/tf-segnet/Logs", """ dir to store ckpt """)
tf.app.flags.DEFINE_string('image_dir', "/pylon5/sy4s8lp/kbushman/tf-segnet/train.txt", """ path to CamVid image """)
tf.app.flags.DEFINE_string('test_dir', "/pylon5/sy4s8lp/kbushman/tf-segnet/test.txt", """ path to CamVid test image """)
tf.app.flags.DEFINE_string('val_dir', "/pylon5/sy4s8lp/kbushman/tf-segnet/test.txt", """ path to CamVid val image """) #using test as validation
tf.app.flags.DEFINE_string('output_image_dir', "/pylon5/sy4s8lp/kbushman/tf-segnet/out_images/1/", """ path to output test images to """)
